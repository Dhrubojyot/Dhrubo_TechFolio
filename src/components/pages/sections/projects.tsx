  ...
  const projects = [
    {
      title: "Dev Doodle",
      description:
        "Dev Doodle is a unified real-time platform for developers and designers to code, sketch, chat, and collaborate—replacing VS Code Live Share, Copilot, whiteboards, and video apps in one place.",
      tags: ["React", "TypeScript", "Socket.IO", "CodeMirror", "Tldraw", "Gemini"],
      github: "https://github.com/Dhrubojyot/Dev_Doodle",
      image: "/devdoodle.png",
      live: "https://youtu.be/qb6LNpf0Pvg?si=veyJx0eKIX9_2_oA",
      date: "June, 2025",
      status: "completed",
    },
    {
      title: "Linux Portfolio",
      description: "Linux Portfolio is a unique terminal-inspired developer portfolio that recreates the experience of working in a Linux command-line interface. Visitors can navigate the portfolio using familiar terminal commands to explore projects, technical skills, achievements, certifications, experience, and contact information.",
      tags: ["Linux Terminal UI", "Command-Based Navigation", "Interactive CLI Experience", "Fast and Lightweight"],
      github: "https://github.com/Dhrubojyot/terminal-dhrubojyoti-dev",
      image: "/terminal.png",
      live: "https://dhrubojyoti-cli.netlify.app/",
      date: "August, 2025",
      status: "completed",
    },
    {
      title: "Ai Doctor 2.0",
      description:
        "AI Doctor 2.0 is a multimodal medical chatbot that combines computer vision, speech recognition, and generative AI to provide an interactive healthcare experience. Users can upload medical images, describe symptoms through voice or text, and receive AI-generated insights, explanations, and general health guidance.",
      tags: ["Multimodal AI", "Speech-to-Text (Whisper)", "Computer Vision", "Llama 3 Vision", "Healthcare AI",],
      github: null,
      image: "/medical.png",
      live: "https://youtu.be/sVR0EgQ_ubE?si=kVf1n27yUSSd0PLV",
      date: "February, 2026",
      status: "completed",
    },
  ];
